...
const Navbar: React.FC = () => {
  ...
  if (localStorage.getItem("vendorFilter") === null) {
    localStorage.setItem("vendorFilter", "");
  }
  if (localStorage.getItem("aircraftFilter") === null) {
    localStorage.setItem("aircraftFilter", "");
  }
  if (localStorage.getItem("systemFilter") === null) {
    localStorage.setItem("systemFilter", "");
  }
  if (localStorage.getItem("presetTypeFilter") === null) {
        ...
        <div className="mt-2 flex w-full items-center justify-between md:mt-0">
          <Link href={"/"}>
            <a className="flex max-w-[8rem] p-1">
              <Image loader={customLoader} priority src={hhLogo} unoptimized />
            </a>
          </Link>
