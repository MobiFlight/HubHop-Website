<template>
  <div class="container min-h-screen mx-auto px-2 md:mt-10 -mt-10 mb-10 text-left">
    ...
    <p>
      ...
      "Cookies", Textdateien, die auf Ihrem Computer gespeichert werden und die
      eine Analyse der Benutzung der Website ermöglicht. Google AdSense
      verwendet auch so genannte Web Beacons (unsichtbare Grafiken). Durch diese
      Web Beacons können Informationen wie der Besucherverkehr auf diesen Seiten
      ausgewertet werden.
    </p>
    <p>
    ...
    <p>
      ...
      oder in Ihrem Google-Profil, oder an anderen Stellen auf Websites und
    ...
    <p>
      ...
      Market St, Suite 900, San Francisco, CA 94103, USA. Durch das Benutzen von
    ...
    <p>
      ...
      <a href="http://twitter.com/account/settings" target="_blank"
        >http://twitter.com/account/settings</a
      >
      ändern.
    </p>
    <p></p>
    <p>
      <em
        ...
        <a
          ...
          target="_blank"
          >eRecht24 Datenschutzerklärung für Facebook</a
        >,
        <a
          rel="nofollow"
          href="http://www.google.com/intl/de/analytics/learn/privacy.html"
          target="_blank"
          >Datenschutzerklärung Google Analytics</a
        >,
        <a
          rel="nofollow"
          ...
          target="_blank"
          >Datenschutzerklärung für Google Adsense</a
        >,
        <a
          rel="nofollow"
          href="http://www.google.com/intl/de/+/policy/+1button.html"
          target="_blank"
          >Datenschutzerklärung Google +1</a
        >,
        <a rel="nofollow" href="http://twitter.com/privacy" target="_blank"
          >Datenschutzerklärung Twitter</a
        ></em
      >
    </p>
  </div>
